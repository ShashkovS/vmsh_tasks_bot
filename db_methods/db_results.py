...
class DB_RESULT(DB_ABC):
    ...
    Methods:
    - insert(student_id: int, problem_id: int, lesson: int, teacher_id: int, verdict: int,
    ...
    - list_student_results(student_id: int, lesson: int) -> List[dict]:
        Returns a list of dictionaries representing the results of a given student in a specific lesson.

    - list_all_student_results(student_id: int) -> List[dict]:
        Returns a list of dictionaries representing all the results of a given student.
    ...
    - get_student_solved(student_id: int, lesson: int) -> List[dict]:
        Returns a list of dictionaries representing the problems that a given student has solved in a specific lesson.
