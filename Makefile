...
.PHONY: pwa-format pwa-lint pwa-typecheck pwa-test pwa-storybook-test pwa-build pwa-e2e pwa-e2e-auth pwa-e2e-content pwa-e2e-submissions pwa-e2e-review pwa-e2e-support pwa-e2e-classrooms pwa-e2e-oral pwa-e2e-functional pwa-e2e-realtime pwa-e2e-runtime pwa-visual pwa-visual-update telegram-history-test
pwa-format:
