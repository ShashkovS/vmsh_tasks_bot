...
state_processors = {
    STATE.GET_USER_INFO: prc_get_user_info_state,
    STATE.GET_TASK_INFO: prc_get_task_info_state,
    STATE.SENDING_SOLUTION: prc_sending_solution_state,
    STATE.SENDING_TEST_ANSWER: prc_sending_test_answer_state,
    STATE.WAIT_SOS_REQUEST: prc_wait_sos_request_state,
    STATE.STUDENT_IS_IN_CONFERENCE: prc_student_is_in_conference_state,
    STATE.STUDENT_IS_SLEEPING: prc_student_is_sleeping_state,
    STATE.TEACHER_SELECT_ACTION: prc_teacher_select_action,
    STATE.TEACHER_IS_CHECKING_TASK: prc_teacher_is_checking_task_state,
    STATE.TEACHER_ACCEPTED_QUEUE: prc_teacher_accepted_queue,
    STATE.TEACHER_WRITES_STUDENT_NAME: prc_teacher_writes_student_name_state,
}
