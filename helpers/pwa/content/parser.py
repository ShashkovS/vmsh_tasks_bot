...
class LatexAstParser:
    ...
    def _tikz_figure(
        ...
        *,
        ...
        # A TikZ block is not a user-supplied asset.  Its SVG is generated by
        # the Staff asset pipeline before the final compile; a missing cache
        # entry is therefore a recoverable preparation state, never a LaTeX
        # diagnostic.  External \includegraphics files keep asset.missing.
        return self._count(
            FigureNode(
