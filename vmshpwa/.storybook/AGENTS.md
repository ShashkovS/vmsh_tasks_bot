...
- Story files cite the page/component requirement they demonstrate; interaction tests name the behavioral decision they prove.
- Storybook/testing documentation links back to exact story titles or filenames and implementing components.
- Keep `dev/design-system/STATUS.md` and `06-storybook-and-testing.md` current with matrix coverage, tool versions, exceptions, and gate results.
