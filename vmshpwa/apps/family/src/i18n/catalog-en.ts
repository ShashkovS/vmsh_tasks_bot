...
import { messages as family } from '../locales/en.po'

/** English catalog of the Family app and every `@vmsh/*` package it uses. */
export const messages = { ...ui, ...content, ...product, ...appShell, ...family }
