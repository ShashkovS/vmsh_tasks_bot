...
## Уточнение очереди — 2026-09-13

Дополнение 2026-09-14: реализованы вложения в ответы учителя/администратора
на `/staff/questions/:threadId`. Общий photo composer, приватное чтение школьником,
проверка владельца и scope при привязке, повторная отправка без дублей;
описание и тесты — [фото в вопросах](../../docs/question-photos.md).

Принят план понятной сводки, фильтров курса/группы, сортировки карточек и
сохранения настроек при возврате из проверки. Реализация и критерии:
[серийная проверка](../../docs/serial-review.md#понятная-очередь-и-фильтры).
API и leases сохраняются; общие счётчики учитывают уникальный logicalCaseId.
