...
### Старые шахматные includegraphics, 14 сентября 2026

Изолированный TikZ теперь заменяет известные шахматные PNG-вставки
нативными векторными фигурами, сохраняя размеры.
[Контракт](../../docs/tikz-chess.md), [отчёт](../tikz-chess-report.md).

## Рисунки в материалах и публикация расположения, 15 сентября 2026

Разделение ответов/решений по пунктам и редактор вхождений описаны в [контракте](../../docs/figure-layout.md).
