...
| Модель данных       | accepted planning input   | Включены catalog/layout/assignment версии аудиторий и прежние workflow |
| API/events/files    | accepted planning input   | Права, classroom contracts/events и phase boundaries синхронизированы |
