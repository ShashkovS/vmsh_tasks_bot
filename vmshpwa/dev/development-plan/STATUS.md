...
## Большие пакеты родителей — 12 сентября 2026, готово к выпуску
...
получают новый login suffix. Audit подтвердил две одинаковые пачки по 1138;
production-очистка не выполнялась и ждёт решения владельца.
