...
- Этап 0 не закрыт: workload пока не измеряет concurrent sessions/write latency/photo bytes/outbox/`SQLITE_BUSY` budget; Telegram preflight и runtime-isolation E2E ещё впереди.
