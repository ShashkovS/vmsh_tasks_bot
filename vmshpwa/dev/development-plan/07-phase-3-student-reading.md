...
- Разделы и пояснения между задачами остаются на своих местах в полной
  простыне; controls предыдущей задачи выводятся до них. Раскрытое решение не
  повторяет ни условие, ни следующий общий раздел.
