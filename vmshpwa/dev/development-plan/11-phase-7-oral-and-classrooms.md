...
### 2026-09-15 — недельный черновик окон, реализовано локально

Несколько групп связаны с одной записью окна (миграция 0094); редактирование
применяется сразу ко всем. Клон окна и черновик прошлой недели с переносом на
семь дней не публикуются до подтверждения; отдельные дни исключаются.
Компактный Student-рендер скрывает пустые/прошедшие окна. Пройдены браузерные
сценарии Chromium/Firefox/WebKit и сборки трёх приложений. Не выпущено.
[Требования и прогресс](../../docs/oral-window-weekly-drafts.md).
