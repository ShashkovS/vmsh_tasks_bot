...
iframe только по действию читателя; print выводит ссылку вместо player. Нужны
отдельные E2E/visual снимки и ручная проверка реальных provider-плееров перед
выпуском.
