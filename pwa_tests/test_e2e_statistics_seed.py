...
def _owners(connection: sqlite3.Connection) -> None:
    ...
    connection.execute(
        "INSERT INTO seasons "
        "(id, code, title, starts_on, ends_on, session_expires_on, status, "
    ...
    connection.executemany(
        ...
        [
            (1, "н", "н", "Начинающие", 1, 1),
            (2, "п", "п", "Продолжающие", 2, 0),
        ],
    )
    connection.executemany(
        "INSERT INTO users (id, type, group_id, name, surname, online) "
