...
async def start(message: types.Message):
    ...
    await bot.send_message(
        ...
        text="🤖 Привет! Это бот для сдачи задач, вот этих: https://shashkovs.ru/vmsh/2024/n/#09-n.\n"
             "Если задачи окажутся простоватыми, то можно выполнить команду /level_pro и решать вот эти задачи https://shashkovs.ru/vmsh/2024/p/#09-p, они сложнее и их больше.",
    )
